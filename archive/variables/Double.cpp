...
namespace variable {
    ...
    Object* Double::add (Object* other) {
        ...
        if (otherType == "Integer") return new Double(value + static_cast<Integer*>(other)->value);
    ...
    Object* Double::modulo (Object* other) {
        string otherType = other->getType();
        if (otherType == "Integer") return new Double(std::fmod(value, static_cast<Integer*>(other)->value));
    ...
    map<string, objectF> Double::getFunctions() {
        return {};
    }

...
namespace library {
    ...
    void MathLibrary::linkGlobally(Scope &s) {
        ...
        s.functions["round"] = [](vector<Object*> &args) -> Object* {
            ...
            if (t == "Integer" || t == "Double" || t == "Long") return {new Integer(std::round(stod(args[0]->getValueString())))};
        ...
        s.functions["floor"] = [](vector<Object*> &args) -> Object*{
            ...
            string t = args[0]->getType();
            if (t == "Integer" || t == "Double" || t == "Long") return {new Integer(std::floor(stod(args[0]->getValueString())))};
        ...
        s.functions["ceil"] = [](vector<Object*> &args) -> Object*{
            ...
            string t = args[0]->getType();
            if (t == "Integer" || t == "Double" || t == "Long") return {new Integer(std::ceil(stod(args[0]->getValueString())))};
            throw runtime_error("You can floor function only double or integer");
        };
        // (F)power function
        s.functions["pow"] = [](vector<Object*> &args) -> Object*{
            ...
            if ((t == "Integer" || t == "Double" || t == "Long") && (t2 == "Integer" || t2 == "Double"))
        ...
        s.functions["sqrt"] = [](vector<Object*> &args) -> Object*{
            ...
            string t = args[0]->getType();
            if (t == "Integer" || t == "Double" || t == "Long") return {new Double(std::sqrt(stod(args[0]->getValueString())))};
        ...
        s.functions["nthroot"] = [](vector<Object*> &args) -> Object*{
            ...
            string t = args[0]->getType();
            string t2 = args[1]->getType();
            if ((t == "Integer" || t == "Double" || t == "Long") && (t2 == "Integer" || t2 == "Double" || t2 == "Long"))
        ...
        s.functions["max"] = [](vector<Object*> &args) -> Object*{
            ...
            for (Object* e : a) {
                ...
                if (t == "Integer" || t == "Long") {if (iv > mi) mi = std::max(mi, iv);}
